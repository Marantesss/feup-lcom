#ifndef _VIDEOMACROS_H_
#define _VIDEOMACROS_H_

/** @defgroup videomacros videomacros
 * @{
 *
 * Macros and key values used to work with graphics mode
 */
...
#define VBE_GAME_MODE   0x143 /* 800x600   Direct Colors   32 bits (8:8:8:8) */
#define VBE_GRAPHIC_4   0x11A /* 1280x1024 Direct Colors   16 bits (5:6:5) */
#define VBE_GRAPHIC_5   0X14B /* 1152x864  Direct Colors   24 bits (8:8:8) */
#define VBE_GRAPHIC_6   0x14C /* 1152x864  Direct Colors   32 bits ((8:)8:8:8) */
